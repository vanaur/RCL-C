...
struct RCL_Structure_Field_
{
  ...
  union
  {
    struct { LIdent lident_; hash_t hash_code; } freefield_;
    struct { LIdent lident_; hash_t hash_code; } enumfield_;
    struct { Identifier identifier_; LIdent lident_; hash_t hash_code; } specfield_;
  } u;
};
